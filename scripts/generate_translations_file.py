...
# Language codes to JavaScript variable names
code_map = {
    'en': 'en',
    'es': 'es',
    'fr': 'fr',
...
def merge_dict(target):
    res = {}
    for group, keys in master.items():
        res[group] = {}
        for k, v in keys.items():
            res[group][k] = target.get(group, {}).get(k, v) if isinstance(target, dict) else v
    return res

print("Loaded python translation generator.")
